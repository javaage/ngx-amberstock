...
@Component({
  selector: 'ngx-index-compare',
  templateUrl: './index-compare.component.html',
  styleUrls: ['./index-compare.component.scss']
})
export class IndexCompareComponent implements OnInit {
  ...
  showDelta(indexs) {
    ...
    this.themeSubscription = this.theme.getJsTheme().subscribe(config => {
      ...
      this.stockService.indexCompare (indexs,this.datePipe.transform(this.dtStart, 'yyyyMMdd')).subscribe(result => {
        this.options = {
